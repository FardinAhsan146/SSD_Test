...
def send_violations(measurement,room_number):

    print("Sending Violations")
    publish("s/us", f"200,c8y_Violations_{room_number},Violations,{measurement}")

def send_number_people(measurement,room_number):

    print("Sending People")
    publish("s/us", f"200,c8y_TotalPeople_{room_number},Total People,{measurement}")
